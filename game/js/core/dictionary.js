...
(function (root) {
  ...
  Dictionary.prototype.findInStack = function (letters, minLength, maxLength) {
    ...
    // Подмножествата са 2^n. При стойка от 7 това са 127 - нищо. При 30
    // би замразило браузъра, затова спираме шумно вместо да увиснем.
    // Проверката на конфигурацията отрязва това по-рано; тук е за случая,
    // в който някой вика функцията направо.
    if (n > 20) {
      console.error("[речник] стойка от " + n + " букви е твърде голяма " +
        "за търсене по подмножества (таван 20).");
      return [];
    }
