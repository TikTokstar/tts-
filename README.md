...
измислени зрители. За стрийма е `2-ПУСНИ-ИГРАТА.bat`.

Не иска инсталация, Python, интернет или ключове. Речникът и звуците са в
репото.

Играта чете от **TikFinity** по подразбиране. Ако програмата не върви, най-долу
на екрана пише защо — в зоната, която TikTok закрива, така че зрителите не
го виждат.

1. Пусни TikFinity и го свържи с акаунта си
2. Отвори `game/chat-test.html`, натисни бутона **TikFinity** и напиши нещо
   в чата на стрийма — това проверява веднъж дали схемата на твоя TikFinity
   съвпада с очакваната
