...
**Двоен клик върху `game/index.html`.** Това е всичко.

Играта тръгва веднага с мним чат — измислени зрители познават думи сами, за
да видиш как работи. Не иска инсталация, Python, интернет или ключове.
Речникът и звуците са в репото.

Когато си готов за истински чат:

1. Пусни TikFinity и го свържи с акаунта си
2. В `game/config.js` смени `source: "mock"` на `source: "tikfinity"`
3. Отвори `game/chat-test.html?source=tikfinity&debug=1`, напиши нещо в
   чата на стрийма и виж дали влиза — това проверява веднъж дали схемата
   на твоя TikFinity съвпада с очакваната
4. Добави browser source **1080 × 1920** към `game/index.html`
